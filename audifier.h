...
public:
    ...
    void addParent(SynthItem* parent) override;
    void removeParent(SynthItem* parent) override;
...
private:
    ...
    void processAddParent(SynthItem* parent);
    void processRemoveParent(SynthItem* parent);
